...
export const aboutHero = {
  image: "/images/about-hero-88.png",
  title: {
    en: "About Tarakeeb",
    ar: "عن تركيب",
...
export const philosophy = [
  {
    en: "Tarakeeb is a luxury artisanal house rooted in Bahrain and shaped by dialogue across cultures. Every collection is an exploration of balance: restraint and expression, structure and fluidity, heritage and contemporary life.",
    ar: "تركيب دار حرفية فاخرة، جذورها في البحرين وتتشكل عبر حوار بين الثقافات. كل مجموعة هي بحث في التوازن: بين الرصانة والتعبير، وبين البناء والانسياب، وبين الإرث والحياة المعاصرة.",
  } satisfies LocalizedString,
  {
    en: "We collaborate with master artisans and small workshops to preserve techniques that deserve continuity. The result is a wardrobe of intentional pieces that honour material intelligence and dignified presence.",
    ar: "نتعاون مع حرفيين خبراء وورش صغيرة للحفاظ على تقنيات تستحق الاستمرارية. والنتيجة خزانة من القطع المقصودة التي تكرّم ذكاء الخامة وحضورها الراقي.",
  } satisfies LocalizedString,
];
...
Tarakeeb remains, at its core, an exploration of continuity — of culture, of material, and of considered design.`,
    ar: `«تركيب ما بدأت كفكرة تجارية.
بدأت كذائقة شخصية.»

من عمر مبكر، كانت كانيكا سوبروال تميل إلى الأقمشة الطبيعية والخطوط الكلاسيكية — قطع تعيش أكثر من موسم. بالنسبة لها، اللباس لم يكن يومًا استعراضًا؛ كان راحة وتناسبًا وكرامة هادئة.
...
ومن هنا جاءت تركيب كإجابة على هذا السؤال.

ممارسة ترتكز على الأنسجة الطبيعية.
والتزام بالحياكة والتطريز اليدوي.
وحوار بين البحرين وما بعدها.

وتحت قيادة كانيكا، تواصل العلامة استكشاف رحلة الحرفة — كيف يمكن لقماش يُنسج في مكان، ويُنتقى من مكان آخر، ويُطرّز في جهة ثالثة أن يجتمع في قطعة معاصرة متماسكة.

وتبقى تركيب، في جوهرها، بحثًا في الاستمرارية — استمرارية الثقافة، والخامة، والتصميم الواعي.`,
  } satisfies LocalizedString,
};
...
export const craftNarrative = [
  ...
  {
    title: {
      en: "India-Bahrain Journey",
      ar: "رحلة الهند والبحرين",
    } satisfies LocalizedString,
    text: {
      en: "Patterns, trims, and constructions travel between ateliers in India and Bahrain. This exchange allows each garment to carry multiple histories while maintaining a single refined identity.",
      ar: "الزخارف والتفاصيل والبناءات تنتقل بين الأتيليهات في الهند والبحرين. هذا التبادل يمنح كل قطعة طبقات متعددة من الحكايات مع الحفاظ على هوية واحدة راقية.",
    } satisfies LocalizedString,
    image: "/images/craft-journey-22.png",
  },
  {
    title: {
      en: "Hand Embroidery",
    ...
    text: {
      en: "Embroidery is applied selectively as emphasis, not excess. Motifs are developed with intention, ensuring each detail supports the silhouette rather than competing with it.",
      ar: "يُستخدم التطريز بانتقائية كعنصر تأكيد لا كزخرفة مفرطة. وتُطوَّر النقوش بقصد واضح، بحيث يدعم كل تفصيل الخط العام بدل أن ينافسه.",
    } satisfies LocalizedString,
    image: "/images/craft-embroidery-99.png",
  },
];
